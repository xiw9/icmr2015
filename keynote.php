      ...
      <div class="col-md-9">
        <div class="panel panel-primary">
          ...
          <div class="panel-body" >
            <a name="keynote1"></a>
            <h3>Keynote 1: Multimedia Retrieval: Are We Doing it Right? [<a href="doc/ICMR-Keynote-Talk-Jun2015.pdf">Slides</a>]</h3>
            ...
            <p>These are also the sorts of models that builders of large-scale“commonsense” knowledge bases have been working to construct. But, to date, although some such knowledge bases support particular instances of each kind of reasoning task, they do not approach doing so comprehensively, even within quite narrow domains. Although some work is being done on automating KB construction, this generally aims at breadth, rather than density.</p>
            <p>Similarly, although machine vision and NLP researchers have long discussed the potential use of background knowledge in scene and text understanding, demonstrating that utility in any general way has been hampered by the vast incompleteness of available KBs. </p>
            <p>The time is ripe for a 5-10 year AI challenge problem in production of dense models directly from data. As a particular example, kitchens are somewhat limited in complexity, from a human point of view, and are densely modelled by most humans; we are not frequently surprised by what we find in a kitchen, or by what happens there. And we are not lacking for data; there are more than 6 million YouTube hits for “kitchen”, around 5 million for cooking. If each was a mere 1 minute long, this represents 22 years of kitchen video. Dull perhaps, but also, presumably, enough grist for building a very dense model. </p>
            ...
            <h4>Bio</h4>
            <p>Yongjian Wu is the team manager of BestImage team and a senior research fellow of Social Network Platform Department in Tencent. He Joined in Tencent in 2008 and has been working on the multimedia research field, machine learning and high performance computing technology till now, and owns many international patents with the research results. With his leading on the research in multimedia, the research results have been widely used in many company-level products, such as Q-Zone, QQ Music, Tencent Map, Pitu and Webank, and have made many outstanding achievements inside and outside the company, such as ShangHai Technology Advanced Award, "Key Technology Breakthough Award" of Tencent in two consecutive years, and also been reported by many public media like CCTV, 36Kr.com and LeiPhone.com.</p>
          </div>
        </div>  
      </div>
      <div class="col-md-3">
