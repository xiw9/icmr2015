...
<body>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="logo navbar-btn pull-left" href="/" title="Home">
            <img src="img/icmr-sm.png" alt="Home" />
          </a>
        </div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="img/header-1.jpg" alt="First slide">
        <div class="container">
          <div class="carousel-caption">
            <h1>International Conference on Multimedia Retrieval 2015</h1>
            <p>The annual ACM International Conference on Multimedia Retrieval will take place between June 23-26, 2015 in Shanghai, China. </p>
          </div>
        </div>
      </div>
      <div class="item">
        <img src="img/header-2.jpg" alt="Second slide" >
        <div class="container">
          <div class="carousel-caption">
            <h1>International Conference on Multimedia Retrieval 2015</h1>
      ...
      <div class="item">
        <img src="img/header-3.jpg" alt="Third slide" >
        <div class="container">
          <div class="carousel-caption">
            <h1>International Conference on Multimedia Retrieval 2015</h1>
            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
  ...
  <div class="container marketing">
    <div class="row featurette">
      ...
      <div class="col-md-4">
        <img class="featurette-image img-responsive" src="img/icmr.png" alt="ICMR 2015">
      </div>
    </div>
    <hr class="featurette-divider">
    <div class="row">
      <div class="col-lg-4">
        <img  src="img/notepad.png" style="width: 100px; height: 100px;">
        <h2>Recently Updates</h2>
        <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
        <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img src="img/calendar.png" style="width: 100px; height: 100px;">
        <h2>Important Dates</h2>
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
        <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img src="img/direction.png" style="width: 100px; height: 100px;">
  ...
  <footer>
    <div class="footer">
      <div class="container narrow row-fluid">
        ...
        <p>&copy; 2015 ACM International Conference on Multimedia Retrieval (ICMR 2015)</p>
        <p>Shanghai, China, June 23-26, 2015</p>
      </div>
    </div>
  </footer>
