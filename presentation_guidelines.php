...
<head>
  ...
  <title>Presentation Guidelines | ACM ICMR 2015 | Shanghai, China</title>
</head>
<body>
      ...
      <div class="col-md-9">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h1 class="panel-title">Presentation Guidelines</h1>
          </div>
          <div class="panel-body" >
            <p>Presenters are requested to prepare their presentations as follows. 
              Please carefully refer to the <a href="program">program</a> to check the presentation date, time, and type. 
              For workshops, please follow the instructions from the workshop organizers.</p>
            <h3>Oral Presentations</h3>
            <p>Each paper in an oral session is allocated 20 minutes. 
              This includes time required for the introduction of the speaker, as well as time for questions from the audience. 
